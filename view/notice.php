...
?>
<div <?php echo $id; ?> class="notice <?php echo $type; ?><?php echo ( $dismissible ) ? ' is-dismissible' : ''; ?> as3i-notice <?php echo ( $inline ) ? ' inline' : ''; ?> <?php echo empty( $class ) ? '' : ' ' . $class; ?>" style="<?php echo $style; ?>">
	<?php if ( $auto_p ) : ?>
	<p>
		<?php endif; ?>
		<?php echo $message; // xss ok ?>
		<?php if ( false !== $show_callback && is_callable( $show_callback ) ) : ?>
			<a href="#" class="as3i-notice-toggle" data-hide="<?php _e( 'Hide', 'aws-s3-integration' ); ?>"><?php _e( 'Show', 'aws-s3-integration' ); ?></a>
		<?php endif; ?>
		<?php if ( $auto_p ) : ?>
	</p>
<?php endif; ?>
	<?php if ( false !== $show_callback && is_callable( $show_callback ) ) : ?>
		<div class="as3i-notice-toggle-content" style="display: none;">
