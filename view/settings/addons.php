...
<div id="tab-addons" data-prefix="as3cf" class="as3cf-tab as3cf-content as3cf-addons">
	...
	<?php if ( ! $this->is_pro() ) : ?>
		<div class="notice inline as3cf-get-addons as3cf-notice-warning">
			<p>
			<?php
				printf( __( '<strong>Get Addons</strong> — The following addons are available with a WP Offload Media Gold license or better.<br>Visit <a href="%s">deliciousbrains.com</a> to purchase in just a few clicks.', 'aws-s3-integration' ),
