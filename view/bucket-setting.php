...
<tr class="as3cf-bucket <?php echo $tr_class; ?>">
	...
	<td>
		...
		<a id="<?php echo $prefix; ?>-view-bucket" target="_blank" class="as3cf-view-bucket" href="<?php echo $this->get_provider()->get_console_url( $selected_bucket, $selected_bucket_prefix ); ?>" title="<?php _e( 'View in provider\'s console', 'aws-s3-integration' ); ?>">
		...
		<?php if ( defined( $constant_bucket ) || false !== $this->get_defined_setting( 'bucket', false ) ) {
			...
			<a href="<?php echo $this->get_plugin_page_url( array( 'action' => 'change-bucket' ) ); ?>" id="<?php echo $prefix; ?>-change-bucket" class="as3cf-change-bucket"><?php _e( 'Change', 'aws-s3-integration' ); ?></a>
		<?php } ?>

		<p id="<?php echo $prefix; ?>-active-region" class="as3cf-active-region" title="<?php _e( 'The region that the bucket is in.', 'aws-s3-integration' ); ?>">
