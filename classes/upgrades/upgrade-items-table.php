...
class Upgrade_Items_Table extends Upgrade {
	...
	protected function get_running_update_text() {
		return __( 'and updating the plugin\'s metadata to use a faster storage method. During the update the site\'s total offloaded media count may be inaccurate but will settle down shortly after completing.', 'aws-s3-integration' );
	}
